...
//mongoose.model : its tell in which collection u want to put the data, here we give the collection name as 'user', the data will be put inside 'user' collection when we will check on mongoCompass
